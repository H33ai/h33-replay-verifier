/* @ts-self-types="./h33_replay_verify_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function sha3_256Hex(bytes) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sha3_256Hex(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
export function verifierVersion() {
    ...
    let deferred1_1;
    try {
        const ret = wasm.verifierVersion();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {any}
 */
export function verifyBundle(bundle_json, strict) {
    const ptr0 = passStringToWasm0(bundle_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.verifyBundle(ptr0, len0, strict);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./h33_replay_verify_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('h33_replay_verify_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
